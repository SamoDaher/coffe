...
function App() {
	...
	const [url, setUrl] = useState('https://buzunov.ru/wp-content/uploads/2014/05/fcoffie-small.jpg')
	const [title, setTitle] = useState('Данный кофе отсутсвует')
	const [description, setDescription] = useState('Попробуйте выбрать другие ингридиенты')
	...
	*/
	const onchange = (e) => {
		...
		if (k === 0) {
			setUrl('https://buzunov.ru/wp-content/uploads/2014/05/fcoffie-small.jpg')
			setTitle('Данный кофе отсутствует')
			setDescription('Попробуйте выбрать другие ингредиенты')
		}
	}
	/*Returned Html data*/
	return (
